ServerEvents.recipes(event => {
    ...
    let o = 'mekanism:combiner'
    let b = 'mekanism:basic_combining_factory'
    let a = 'mekanism:advanced_combining_factory'
    let e = 'mekanism:elite_combining_factory'
    let u = 'mekanism:ultimate_combining_factory'
    ...
    , 'mekanism:steel_casing', [
         event.recipes.create.deploying(inter1, [inter1, 'ic2:pressure_alloy_furnace']) //Шаблон руки
        ,event.recipes.create.deploying(inter1, [inter1, 'mekanism:elite_control_circuit']) //Шаблон руки
        ,event.recipes.create.deploying(inter1, [inter1, 'mekanism:alloy_atomic']) //Шаблон руки
...
//        ,event.recipes.create.cutting(inter, inter) // Шаблон пилы
    ...
    , o, [
        ...
        ,event.recipes.create.deploying(inter2, [inter2, 'minecraft:redstone']) //Шаблон руки
        ,event.recipes.create.deploying(inter2, [inter2, 'ic2:pressure_alloy_furnace']) //Шаблон руки
        ,event.recipes.create.pressing(inter2, inter2) // Шаблон пресса
//        ,event.recipes.create.filling(inter, [inter, Fluid.of('FluidId', 10)]) //Шаблон дозатара
//        ,event.recipes.create.cutting(inter, inter) // Шаблон пилы
