ServerEvents.recipes(event => {
    ...
    let o = 'mekanism:osmium_compressor'
    let b = 'mekanism:basic_compressing_factory'
    let a = 'mekanism:advanced_compressing_factory'
    let e = 'mekanism:elite_compressing_factory'
    let u = 'mekanism:ultimate_compressing_factory'
    ...
    , 'mekanism:steel_casing', [
         event.recipes.create.deploying(inter1, [inter1, 'ic2:uranium_enricher']) //Шаблон руки
        ,event.recipes.create.deploying(inter1, [inter1, 'mekanism:advanced_control_circuit']) //Шаблон руки
        ,event.recipes.create.deploying(inter1, [inter1, 'mekanism:alloy_reinforced']) //Шаблон руки
...
//        ,event.recipes.create.cutting(inter, inter) // Шаблон пилы
    ...
    , o, [
        ...
        ,event.recipes.create.deploying(inter2, [inter2, 'minecraft:redstone']) //Шаблон руки
        ,event.recipes.create.deploying(inter2, [inter2, 'ic2:uranium_enricher']) //Шаблон руки
        ,event.recipes.create.pressing(inter2, inter2) // Шаблон пресса
//        ,event.recipes.create.filling(inter, [inter, Fluid.of('FluidId', 10)]) //Шаблон дозатара
//        ,event.recipes.create.cutting(inter, inter) // Шаблон пилы
