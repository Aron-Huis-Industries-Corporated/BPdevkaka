ServerEvents.recipes(event => {
    ...
    let o = 'mekanism:crusher'
    let b = 'mekanism:basic_crushing_factory'
    let a = 'mekanism:advanced_crushing_factory'
    let e = 'mekanism:elite_crushing_factory'
    let u = 'mekanism:ultimate_crushing_factory'
    ...
    , 'mekanism:steel_casing', [
         event.recipes.create.deploying(inter1, [inter1, 'ic2:rotary_macerator']) //Шаблон руки
...
//        ,event.recipes.create.cutting(inter, inter) // Шаблон пилы
    ...
    , o, [
        ...
        ,event.recipes.create.deploying(inter2, [inter2, 'minecraft:redstone']) //Шаблон руки
        ,event.recipes.create.deploying(inter2, [inter2, 'ic2:rotary_macerator']) //Шаблон руки
        ,event.recipes.create.pressing(inter2, inter2) // Шаблон пресса
//        ,event.recipes.create.filling(inter, [inter, Fluid.of('FluidId', 10)]) //Шаблон дозатара
//        ,event.recipes.create.cutting(inter, inter) // Шаблон пилы
